...
export default function CreateEvent() {
  ...
  const { addReminder, editReminder, selectedReminder, setSelectedReminder, reminders } = useReminder();
  ...
  const handleSave = () => {
    ...
    if (isEditMode && selectedReminder) {
      ...
      const updatedReminder = {
        ...
        category,
        date: selectedDate,
        box: selectedBox || null, // รองรับกรณีไม่เลือกกล่อง
      };
    ...
    const exists = reminders.some(r => r.box === selectedBox && !r.done);
      if (selectedBox && exists) {
        Alert.alert('กล่องถูกใช้งานแล้ว', `กล่อง ${selectedBox} ถูกใช้ไปแล้ว เลือกกล่องอื่น`);
        return;
      }
      ...
      Alert.alert('บันทึกสำเร็จ', 'เพิ่มการแจ้งเตือนเรียบร้อยแล้ว', [
        { text: 'ตกลง', onPress: () => router.back() },
      ]);
    }
  };
  ...
  const handleCancel = () => {
    Alert.alert(
      isEditMode ? 'ยกเลิกการแก้ไข' : 'ยกเลิกการสร้าง',
      isEditMode ? 'คุณต้องการยกเลิกการแก้ไขใช่หรือไม่?' : 'คุณต้องการยกเลิกการสร้างใช่หรือไม่?',
      [
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isEditMode ? 'แก้ไขการแจ้งเตือน' : 'เพิ่มการแจ้งเตือน'}
        </Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.label}>โน๊ต</Text>
          <TextInput
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.previewCard}>
            <View style={styles.previewRow}>
              <View style={styles.previewCategory}>
                <Text style={styles.previewCategoryText}>
                  {selectedBox ? `กล่อง ${selectedBox}` : 'ยังไม่เลือกกล่อง'}
                </Text>
              </View>
            ...
            {note ? <Text style={styles.previewNote}>{note}</Text> : null}
